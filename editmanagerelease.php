<?php error_reporting(0);
    ...
    if(isset($_POST['update'])){
        ...
        $youtube_content_id=@$_POST['youtube_content_id'];
        $revenue=@$_POST['revenue'];
        $status=@$_POST['status'];
        $query="UPDATE songrelease SET date='$date',songrelease='$songrelease',song_name='$song_name',upc='$upc',type_of_release='$type_of_release',language='$language',genre='$genre',sub_catergory='$sub_catergory',song_description='$song_description',release_date='$release_date',owned_exclusive_license='$owned_exclusive_license',album_id='$album_id',isrc='$isrc',label='$label',singer_name='$singer_name',lyricist='$lyricist',artist='$artist',name_of_owner_song='$name_of_owner_song',name_of_owner_music='$name_of_owner_music',actor='$actor',director='$director',producer='$producer',song='$song',poster_name='$poster_name',deployment='$deployment',youtube_content_id='$youtube_content_id',revenue='$revenue',status='$status' WHERE id='$id'" ;
        mysqli_query($connect,$query);
        $msg = 'Your data is successfully updated';
        header('Location:edit-manage-release');
        echo '<script type="text/javascript">window.location.href="edit-manage-release";</script>';
    }
    else{
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form name="submit" action="editmanagerelease" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">    Youtube Content Id</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="youtube_content_id" value="<?php echo $youtube_content_id; ?>" >
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">    Revenue</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="revenue" value="<?php echo $revenue; ?>" >
                                </div>
                            </div>
                            <div class="row mb-3">
