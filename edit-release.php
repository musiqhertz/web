<?php session_start();
    ...
    $checkdata="select * from create_mutliple_release where userid='".$userid."'";
                        ...
                        <div class="card-body">
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="editrelease-single?id=<?php echo $row['track_id'];?>" class="btn btn-dark waves-effect waves-light">Edit</a></td>
                                                </tr>
                                                <?php }}?>
                                                </tbody>
                                            </table>
